...
public class TampilkanReport {
    ...
    public TampilkanReport(Spop spop, ArrayList<NilaiBangunan> listNilBng) {
        this.spop = spop;
    ...
    private void isiLaporanPenilaian() {
        ...
        for(int a = 0; a < arrJabatan.size();a++)
        {
                switch (a) {
                    case 1:
                        lPM.setJabPenilai(arrJabatan.get(a).getJabatan());
                        lPM.setNamaPenilai(arrJabatan.get(a).getNama());
                        lPM.setNipPenilai(arrJabatan.get(a).getNip());
                        break;
                    case 0:
                        lPM.setJabUptd(arrJabatan.get(a).getJabatan());
                        lPM.setNamaUptd(arrJabatan.get(a).getNama());
                        lPM.setNipUptd(arrJabatan.get(a).getNip());
                        break;
                    case 2:
                        lPM.setJabKadis(arrJabatan.get(a).getJabatan());
                        lPM.setNamaKadis(arrJabatan.get(a).getNama());
                        lPM.setNipKadis(arrJabatan.get(a).getNip());
                        break;
                    default:
                        break;
                }
        ...
        lPM.setNamaPemDaerah(head.getNamaPemDaerah());
        lPM.setDinasDaerah(head.getDinasDaerah());
        lPM.setAlamatDinas(head.getAlamatDinas());
    ...
    public void tampilReport() {
            ...
            JasperPrint jspPrtMaster = tool.bentukReport(listLapPenilMaster, "id/co/meda/apit/visual/report/rptLapPenilMaster.jrxml");
