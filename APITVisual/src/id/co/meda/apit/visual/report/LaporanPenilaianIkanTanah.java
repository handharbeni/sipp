 ...
 */
public class LaporanPenilaianIkanTanah {
    ...
    private ArrayList<LaporanPenilaianIkanTanahDetil> tanahIkan;
    private String njop;
    ...
    /**
     * @return the tanahIkan
     */
    public ArrayList<LaporanPenilaianIkanTanahDetil> getTanahIkan() {
        return tanahIkan;
    }

    /**
     * @param tanahIkan the tanahIkan to set
     */
    public void setTanahIkan(ArrayList<LaporanPenilaianIkanTanahDetil> tanahIkan) {
        this.tanahIkan = tanahIkan;
    }
